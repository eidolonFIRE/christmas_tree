...
def color_wheel(pos, bri=1.0):
    ...
    pos = pos % 1.0
    if pos < 0.333333:
        return numpy.array([pos * 3.0 * bri, (1.0 - pos * 3.0) * bri, 0.0], dtype=numpy.float32)
    elif pos < 0.666667:
        pos -= 0.333333
        return numpy.array([(1.0 - pos * 3.0) * bri, 0.0, pos * 3.0 * bri], dtype=numpy.float32)
    else:
        pos -= 0.666667
        return numpy.array([0.0, pos * 3.0 * bri, (1.0 - pos * 3.0) * bri], dtype=numpy.float32)
